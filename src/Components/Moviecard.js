...
const MovieCard = ({...movieItem}) => {
    ...
    return(
        <div className="w-[250px] h-[600px] mt-5 mr-[6px] shadow-default overflow-hidden rounded-lg ease-in-out hover:shadow-hover hover:[text-shadow:1px_0_10px_#FFF] duration-200">
            <img src={(movieItem.poster_path!== undefined) ? "https://image.tmdb.org/t/p/w500/"+movieItem?.poster_path : posterHolder} className='w-full h-[400px] m-auto block ease-in-out hover:shadow-card duration-300' alt="Not found" />
